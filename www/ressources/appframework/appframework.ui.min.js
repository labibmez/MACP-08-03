...
c&&a!==t&&a.parentNode;return m(a)},filter:function(b){if(0===this.length||b==p)return this;for(var c=[],a=0;a<this.length;a++){var d=this[a];d.parentNode&&0<=m(b,d.parentNode).indexOf(d)&&c.push(d)}return this.setupOld(m(k(c)))},not:function(b){if(0===this.length)return this;for(var c=[],a=0;a<this.length;a++){var d=this[a];d.parentNode&&-1==m(b,d.parentNode).indexOf(d)&&c.push(d)}return this.setupOld(m(k(c)))},data:function(b,c){return this.attr("data-"+b,c)},end:function(){return this.oldElement!=
...
error:a,complete:a,context:void 0,timeout:0,crossDomain:null};m.jsonP=function(b){if(C)return b.type="get",b.dataType=null,m.get(b);var a="jsonp_callback"+ ++S,d="",h,e=t.createElement("script");c[a]=function(h){clearTimeout(d);m(e).remove();delete c[a];b.success.call(void 0,h)};-1!==b.url.indexOf("callback=?")?e.src=b.url.replace(/=\?/,"="+a):(h=b.jsonp?b.jsonp:"callback",-1===b.url.indexOf("?")?b.url+="?"+h+"="+a:b.url+="&"+h+"="+a,e.src=b.url);b.error&&(e.onerror=function(){clearTimeout(d);b.error.call(void 0,
"","error")});m("head").append(e);0<b.timeout&&(d=setTimeout(function(){b.error.call(void 0,"","timeout")},b.timeout));return{}};m.ajax=function(b){var d;try{var h=b||{},e;for(e in m.ajaxSettings)"undefined"==typeof h[e]&&(h[e]=m.ajaxSettings[e]);h.url||(h.url=c.location);h.contentType||(h.contentType="application/x-www-form-urlencoded");h.headers||(h.headers={});if(!("async"in h)||!1!==h.async)h.async=!0;m.isObject(h.data)&&(h.data=m.param(h.data));"get"===h.type.toLowerCase()&&h.data&&(-1===h.url.indexOf("?")?
h.url+="?"+h.data:h.url+="&"+h.data);if(h.dataType)switch(h.dataType){case "script":h.dataType="text/javascript, application/javascript";break;case "json":h.dataType="application/json";break;case "xml":h.dataType="application/xml, text/xml";break;case "html":h.dataType="text/html";break;case "text":h.dataType="text/plain";break;case"json":return m.jsonP(h);default:h.dataType="text/html"}else h.dataType="text/html";if(/=\?/.test(h.url))return m.jsonP(h);null===h.crossDomain&&(h.crossDomain=/^([\w-]+:)?\/\/([^\/]+)/.test(h.url)&&
RegExp.$2!=c.location.host);h.crossDomain||(h.headers=m.extend({"X-Requested-With":"XMLHttpRequest"},h.headers));var f,s=h.context,g=/^([\w-]+:)\/\//.test(h.url)?RegExp.$1:c.location.protocol;d=new c.XMLHttpRequest;d.onreadystatechange=function(){var b=h.dataType;if(4===d.readyState){clearTimeout(f);var c,a=!1;if(200<=d.status&&300>d.status||0===d.status&&"file:"==g){if("application/json"===b&&!/^\s*$/.test(d.responseText))try{c=JSON.parse(d.responseText)}catch(e){a=e}else"application/xml, text/xml"===
b?c=d.responseXML:"text/html"==b?(c=d.responseText,m.parseJS(c)):c=d.responseText;0===d.status&&0===c.length&&(a=!0);a?h.error.call(s,d,"parsererror",a):h.success.call(s,c,"success",d)}else a=!0,h.error.call(s,d,"error");h.complete.call(s,d,a?"error":"success")}};d.open(h.type,h.url,h.async);h.withCredentials&&(d.withCredentials=!0);h.contentType&&(h.headers["Content-Type"]=h.contentType);for(var q in h.headers)"string"===typeof h.headers[q]&&d.setRequestHeader(q,h.headers[q]);if(!1===h.beforeSend.call(s,
d,h))return d.abort(),!1;0<h.timeout&&(f=setTimeout(function(){d.onreadystatechange=a;d.abort();h.error.call(s,d,"timeout")},h.timeout));d.send(h.data)}catch(k){console.log(k),h.error.call(s,d,"error",k)}return d};m.get=function(b,c){return this.ajax({url:b,success:c})};m.post=function(b,c,a,d){"function"===typeof c&&(a=c,c={});d===p&&(d="html");return this.ajax({url:b,type:"POST",data:c,dataType:d,success:a})};m.getJSON=function(b,c,a){"function"===typeof c&&(a=c,c={});return this.ajax({url:b,data:c,
success:a,dataType:"json"})};m.param=function(b,c){var a=[];if(b instanceof v)b.each(function(){a.push((c?c+"["+this.id+"]":this.id)+"="+encodeURIComponent(this.value))});else for(var d in b)if(!m.isFunction(b[d])){var h=c?c+"["+d+"]":d,e=b[d];a.push(m.isObject(e)?m.param(e,h):h+"="+encodeURIComponent(e))}return a.join("&")};m.parseJSON=function(b){return JSON.parse(b)};m.parseXML=function(b){if(C)MSApp.execUnsafeLocalFunction(function(){return(new DOMParser).parseFromString(b,"text/xml")});else return(new DOMParser).parseFromString(b,
"text/xml")};d(m,navigator.userAgent);m.__detectUA=d;m.uuid=function(){var b=function(){return(65536*(1+Math.random())|0).toString(16).substring(1)};return b()+b()+"-"+b()+"-"+b()+"-"+b()+"-"+b()+b()+b()};m.getCssMatrix=function(b){m.is$(b)&&(b=b.get(0));var a=c.WebKitCSSMatrix||c.MSCSSMatrix;if(b===p)return a?new a:{a:0,b:0,c:0,d:0,e:0,f:0};b=c.getComputedStyle(b);b=b.webkitTransform||b.transform||b[m.feat.cssPrefix+"Transform"];return a?new a(b):b?(a=b.replace(/[^0-9\-.,]/g,"").split(","),{a:+a[0],
b:+a[1],c:+a[2],d:+a[3],e:+a[4],f:+a[5]}):{a:0,b:0,c:0,d:0,e:0,f:0}};m.create=function(b,c){var a,d=new v;if(c||"<"!==b[0]){c.html&&(c.innerHTML=c.html,delete c.html);a=t.createElement(b);for(var h in c)a[h]=c[h];d[d.length++]=a}else a=t.createElement("div"),C?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=selector.trim()}):a.innerHTML=b,r(a.childNodes,d);return d};m.query=function(b,c){if(!b)return new v;c=c||t;return(new v).selector(b,c)};var x={},N=1;m.event={add:s,remove:F};m.fn.bind=function(b,
c){for(var a=0,d=this.length;a<d;a++)s(this[a],b,c);return this};m.fn.unbind=function(b,c){for(var a=0,d=this.length;a<d;a++)F(this[a],b,c);return this};m.fn.one=function(b,c){return this.each(function(a,d){s(this,b,c,null,function(b,c){return function(){F(d,c,b);return b.apply(d,arguments)}})})};var Q=function(){return!0},R=function(){return!1},P={preventDefault:"isDefaultPrevented",stopImmediatePropagation:"isImmediatePropagationStopped",stopPropagation:"isPropagationStopped"};m.fn.delegate=function(b,
c,a,d){m.isFunction(a)&&(d=a,a=null);for(var h=0,e=this.length;h<e;h++)D(this[h],c,d,b,a);return this};m.fn.undelegate=function(b,c,a){for(var d=0,h=this.length;d<h;d++)F(this[d],c,a,b);return this};m.fn.on=function(b,c,a,d){m.isFunction(a)&&(d=a,a=null);return c===p||m.isFunction(c)?this.bind(b,c):this.delegate(c,b,a,d)};m.fn.off=function(b,c,a){return c===p||m.isFunction(c)?this.unbind(b,c):this.undelegate(c,b,a)};m.fn.trigger=function(b,c,a){"string"==typeof b&&(b=m.Event(b,a));b.data=c;c=0;for(a=
this.length;c<a;c++)this[c].dispatchEvent(b);return this};m.Event=function(b,c){var a=t.createEvent("Events"),d=!0;if(c)for(var h in c)"bubbles"==h?d=!!c[h]:a[h]=c[h];a.initEvent(b,d,!0,null,null,null,null,null,null,null,null,null,null,null,null);return a};m.bind=function(b,c,a){if(b){b.__events||(b.__events={});m.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++)b.__events[c[d]]||(b.__events[c[d]]=[]),b.__events[c[d]].push(a)}};m.trigger=function(b,c,a){if(b){var d=!0;if(!b.__events)return d;m.isArray(c)||
(c=[c]);m.isArray(a)||(a=[]);for(var h=0;h<c.length;h++)if(b.__events[c[h]])for(var e=b.__events[c[h]].slice(0),f=0;f<e.length;f++)m.isFunction(e[f])&&!1===e[f].apply(b,a)&&(d=!1);return d}};m.unbind=function(b,c,a){if(b.__events){m.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++)if(b.__events[c[d]])for(var h=b.__events[c[d]],e=0;e<h.length;e++)if(a==p&&delete h[e],h[e]==a){h.splice(e,1);break}}};m.proxy=function(b,c,a){return function(){return a?b.apply(c,a):b.apply(c,arguments)}};var U=function(b,
c){for(var a=0;a<b.length;a++)z(b[a],c)};m.cleanUpContent=function(b,c,a){if(b){var d=b.childNodes;d&&0<d.length&&m.asap(U,{},[I.apply(d,[0]),a]);c&&E(b,a)}};var H=[],K=[],L=[];m.asap=function(b,a,d){if(!m.isFunction(b))throw"$.asap - argument is not a valid function";H.push(b);K.push(a?a:{});L.push(d?d:[]);c.postMessage("afm-asap","*")};c.addEventListener("message",function(b){b.source==c&&"afm-asap"==b.data&&(b.stopPropagation(),0<H.length&&H.shift().apply(K.shift(),L.shift()))},!0);var M={};m.parseJS=
function(b){if(b){if("string"==typeof b){var a=t.createElement("div");C?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=b}):a.innerHTML=b;b=a}var d=b.getElementsByTagName("script");b=null;for(var h=0;h<d.length;h++)if(0<d[h].src.length&&!M[d[h].src]&&!C){var e=t.createElement("script");e.type=d[h].type;e.src=d[h].src;t.getElementsByTagName("head")[0].appendChild(e);M[d[h].src]=1;e=null}else c.eval(d[h].innerHTML)}};"click keydown keyup keypress submit load resize change select error".split(" ").forEach(function(b){m.fn[b]=
...
setBackButtonText:function(a){"defaultHeader"===this._currentHeaderID&&(this.trimBackButtonText&&(a=a.substring(0,5)+"..."),0<this.backButtonText.length?c.query("#header header:not(.ignore) #backButton").html(this.backButtonText):c.query("#header header:not(.ignore)  #backButton").html(a))},setBackButtonVisibility:function(a){a?c.query("#header #backButton").css("visibility","visible"):c.query("#header #backButton").css("visibility","hidden")},showMask:function(a){a||(a=this.loadingText||"");c.query("#afui_mask>h1").html(a);
c.query("#afui_mask").show()},hideMask:function(){c.query("#afui_mask").hide()},modalReference_:null,showModal:function(a,d){this.modalTransition=d||"up";var f=c.query("#modalContainer");"string"===typeof a&&(a="#"+a.replace("#",""));var e=c.query(a);this.modalReference_=e;if(e.length){var b=this.scrollingDivs.hasOwnProperty(e.attr("id")),b=this.scrollingDivs.hasOwnProperty(e.attr("id"));f.empty();var h;h=c.feat.nativeTouchScroll||!b?e.contents():c(e.get(0).childNodes[0]).contents();f.append(h);f.append("<a onclick='$.ui.hideModal();' class='closebutton modalbutton'></a>");
this.modalWindow.style.display="block";this.runTransition(this.modalTransition,this.modalTransContainer,this.modalWindow,!1);b?this.scrollingDivs.modal_container.enable(this.resetScrollers):this.scrollingDivs.modal_container.disable();this.scrollToTop("modal");f.data("panel",a);f=e.get(0);b=f.getAttribute("data-load");if("string"==typeof b&&window[b])window[b](f);e.trigger("loadpanel")}},hideModal:function(){var a=this,d=c.query("#modalContainer");d.find(".closebutton.modalbutton").remove();var f=
this.scrollingDivs.hasOwnProperty(this.modalReference_.attr("id"));this.runTransition(a.modalTransition,a.modalWindow,a.modalTransContainer,!0);this.scrollingDivs.modal_container.disable();var e=c.query(d.data("panel")),b=e.data("unload");if("string"==typeof b&&window[b])window[b](e.get(0));e.trigger("unloadpanel");setTimeout(function(){c.feat.nativeTouchScroll||!f?a.modalReference_.append(d.contents()):c(a.modalReference_.get(0).childNodes[0]).append(d.contents());d.html("",!0)},this.transitionTime)},
updatePanel:function(a,d){a="#"+a.replace("#","");var f=c.query(a).get(0);if(f){var e=c.create("div",{html:d}),e=e.children(".panel")&&0<e.children(".panel").length?e.children(".panel").get(0):e.get(0);f.getAttribute("js-scrolling")&&("yes"==f.getAttribute("js-scrolling").toLowerCase()||"true"==f.getAttribute("js-scrolling").toLowerCase())?(c.cleanUpContent(f.childNodes[0],!1,!0),c(f.childNodes[0]).html(d)):(c.cleanUpContent(f,!1,!0),c(f).html(d));e.getAttribute("data-title")&&f.setAttribute("data-title",
e.getAttribute("data-title"))}},updateContentDiv:function(a,c){return this.updatePanel(a,c)},addContentDiv:function(a,d,f,e,b){a="string"!==typeof a?a:-1==a.indexOf("#")?"#"+a:a;var h=c.query(a).get(0);h?d=h:(d=c.create("div",{html:d}),d=d.children(".panel")&&0<d.children(".panel").length?d.children(".panel").get(0):d.get(0),!d.getAttribute("data-title")&&f&&d.setAttribute("data-title",f),f=d.id?d.id:a.replace("#",""),d.id=f,d.id!=a&&d.setAttribute("data-crc",a.replace("#","")));d.className="panel";
f=d.id;this.addDivAndScroll(d,e,b);return f},addDivAndScroll:function(a,d,f,e){var b=!1,h,g=a.style.overflow,g="hidden"!=g&&"visible"!=g;e=e||this.content;!c.feat.nativeTouchScroll&&g&&a.setAttribute("js-scrolling","true");if(a.getAttribute("js-scrolling")&&("yes"==a.getAttribute("js-scrolling").toLowerCase()||"true"==a.getAttribute("js-scrolling").toLowerCase()))g=b=!0;h=a.getAttribute("data-title")||a.title;a.title="";a.setAttribute("data-title",h);a.getAttribute("scrolling")&&"no"==a.getAttribute("scrolling")&&
