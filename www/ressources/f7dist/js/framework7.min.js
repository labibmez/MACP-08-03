...
! function() {
 ...
 if (navigator.userAgent.toLowerCase().indexOf('ipad') == -1) {
         ...
         if ((parseInt(screen.width) < 1024) && (parseInt(screen.height) < 720)) {
            ...
            else{ return "function" == typeof a && (t = arguments[1], a = void 0), i.modal({
                text: e || "",
                title: "undefined" == typeof a ? i.params.modalTitle : a ,
                buttons: [{
                    text: i.params.modalButtonOk,
      ...
      sessionStorage.setItem("selectedSearchPopOn",e);          
 createSearchScreenPopOn(e);
 //output = output + '  <li  data-popup=".popup-about"  class="Edit open-popup" id="'+e+'"  onclick=" addItem(this.id);  " >  <label class="label-checkbox item-content">          <input   type="checkbox"  id="' + e  + '"   name = "selectedSearchPopOn"       onchange="sessionStorage.setItem(this.name,this.id);createSearchScreenPopOn(this.id);closeModalLogin();   "    >  <div class="item-media"> <i class="icon icon-form-checkbox"></i>  </div> <div class="item-inner">  <div class="item-title">' + e  + '</div> </div> </label>  </li>    ';
            } else {
                for (var count = 0; count < e.split(',').length; count++) {
                 
                    output = output + '  <li  data-popup=".popup-about"  class="Edit open-popup" id="' + e.split(',')[count] + '"  onclick=" addItem(this.id);  " >  <label class="label-checkbox item-content">     <input   type="checkbox"  id="' + e.split(',')[count] + '"   name = "selectedSearchPopOn"      onchange="sessionStorage.setItem(this.name,this.id);createSearchScreenPopOn(this.id);closeModalLogin();   "    >  <div class="item-media"> <i class="icon icon-form-checkbox"></i>  </div> <div class="item-inner">  <div class="item-title">' + e.split(',')[count] + '</div> </div> </label>  </li>    ';
            ...
            return "function" == typeof a && (n = arguments[2], t = arguments[1], a = void 0), i.modal({
                ...
                buttons: [{
                    ...
                    //   text: '<a href="#" id="" onclick="addItem(this.id,this.name); "    data-popup=".popup-about"  class="Edit open-popup" name=""   >   OK</a>',

                    // text: '<a href="#"  id="" onclick=" addItem(this.id); "   data-popup=".popup-about"  class="Edit open-popup" name=""   >   &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;OK&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; </a>',
                    //   text:'',// 'ok',//'<a href="#"  id="" onclick=" addItem(this.id); "  data-popup=".popup-about"  class="Edit open-popup" name=""    >   &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;OK&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; </a>',
                ...
                if (i.params.modalActionsTemplate) i._compiledTemplates.actions || (i._compiledTemplates.actions = l.compile(i.params.modalActionsTemplate)), p = i._compiledTemplates.actions(a);
                    ...
                    for (var u = "", m = 0; m < a.length; m++)
                        for (var h = 0; h < a[m].length; h++) {
                            ...
                            g.bold && (v += " actions-modal-button-bold"), g.color && (v += " color-" + g.color), 
							g.bg && (v += " bg-" + g.bg), u += '<button  type="button" class="' + v + '"   onClick="alert()" id="'+g.id+'"  > ' + g.text+ '</button>', 
							h === a[m].length - 1 && (u += "</div>")
                        }
                   p = '<div class="actions-modal"   id="ActionSheet" >' + u + ' </div>';///parcourir les autres div
                }
				console.log("actionSheet content  "+p);
            ...
            if (e = s(e), 0 !== e.length) {
                ...
                if (0 !== n.length && (n = n[0].f7View)) {
                    ...
                    if (!(g.disabled || e.hasClass("disabled") || v.hasClass("disabled"))) {
                        ...
                        var G, W = '<form class="searchbar" data-search-list=".smart-select-list-' + M + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + R + '"><a href="#" class="searchbar-clear"></a></div><a href="#" class="searchbar-cancel">' + V + '</a></form><div class="searchbar-overlay"></div>',
        ...
        var g = function(e) {
            ...
            var p = this,
                d = {
                    ...
                    closeOnSelect: !1,
                    monthPicker: !0,
                    monthPickerTemplate: '<div class="picker-calendar-month-picker"><a href="#" class="link icon-only picker-calendar-prev-month"><i class="icon icon-prev"></i></a><span class="current-month-value">August</span><a href="#" class="link icon-only picker-calendar-next-month"><i class="icon icon-next"></i></a></div>',
                    yearPicker: !0,
                    yearPickerTemplate: '<div class="picker-calendar-year-picker"><a href="#" class="link icon-only picker-calendar-prev-year"><i class="icon icon-prev"></i></a><span class="current-year-value">2015</span><a href="#" class="link icon-only picker-calendar-next-year"><i class="icon icon-next"></i></a></div>',
                    weekHeader: !0,
                    scrollToInput: !0,
                    inputReadOnly: !0,
                    convertToPopover: !0,
